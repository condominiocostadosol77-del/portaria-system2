...
export const ResidentsPage: React.FC<ResidentsPageProps> = ({ residents, onRefresh }) => {
  ...
  const confirmDelete = async () => {
    if (deleteId) {
      ...
      if (error) alert('Erro ao excluir morador');
      else onRefresh();
      setDeleteId(null);
    }
  };
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 transform transition-all scale-100">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 mb-6 text-sm">
                Tem certeza que deseja excluir este morador? Esta ação é irreversível.
              </p>
